...
const iconByKey: Record<string, React.ReactNode> = {
  ...
  'course-management': <ReadOutlined />,
  '/admin/academy/certificates': <SafetyCertificateOutlined />,
  '/admin/academy/courses': <ReadOutlined />,
  '/admin/academy/question-banks': <FileTextOutlined />,
  '/admin/academy/exam-records': <OrderedListOutlined />,
