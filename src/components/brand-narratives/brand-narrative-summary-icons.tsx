...
import {
  ...
  type BrandNarrativeSummaryIcon,
...
const summaryIconSvgs: Record<BrandNarrativeSummaryIcon, ReactNode> = {
  layers: (
    <svg {...iconStroke}>
...
export function BrandNarrativeSummaryIconSvg({ icon }: { icon: BrandNarrativeSummaryIcon }) {
